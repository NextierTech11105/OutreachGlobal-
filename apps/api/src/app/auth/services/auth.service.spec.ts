...
describe('AuthService', () => {
  ...
  describe('attempt', () => {
    it('should successfully authenticate with valid credentials', async () => {
      ...
      expect(hashVerify).toHaveBeenCalledWith('hashed-password', 'correct-password');
    });
  ...
  describe('getUser', () => {
    ...
    it('should return user for valid token payload', async () => {
      mockDb.query.users.findFirst.mockResolvedValue(mockUser);
      mockDb.query.personalAccessTokens.findFirst.mockResolvedValue(mockPersonalAccessToken);
    ...
    it('should throw ModelNotFoundError when user not found', async () => {
      ...
      await expect(service.getUser(validPayload)).rejects.toBeInstanceOf(ModelNotFoundError);
    });
  });
