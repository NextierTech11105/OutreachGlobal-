    ...
    <CommandDialog open={open} onOpenChange={setOpen}>
      ...
      <CommandList>
        ...
        <CommandGroup heading="Quick Actions">
          ...
          <CommandItem onSelect={() => runCommand(() => openCalendar())}>
        ...
        <CommandGroup heading="Navigation">
          <CommandItem
            onSelect={() =>
              runCommand(() => router.push(`${basePath}/dashboard`))
            }
          >
          ...
          <CommandItem
            onSelect={() => runCommand(() => router.push(`${basePath}/leads`))}
          >
          ...
          <CommandItem
            onSelect={() =>
              runCommand(() => router.push(`${basePath}/properties`))
            }
          >
          ...
          <CommandItem
            onSelect={() =>
              runCommand(() => router.push(`${basePath}/campaigns`))
            }
          >
          ...
          <CommandItem
            onSelect={() =>
              runCommand(() => router.push(`${basePath}/power-dialer`))
            }
          >
          ...
          <CommandItem
            onSelect={() => runCommand(() => router.push(`${basePath}/inbox`))}
          >
        ...
        <CommandGroup heading="Tools">
          <CommandItem
            onSelect={() =>
              runCommand(() => router.push(`${basePath}/skip-trace`))
            }
          >
          ...
          <CommandItem
            onSelect={() =>
              runCommand(() => router.push(`${basePath}/valuation`))
            }
          >
          ...
          <CommandItem
            onSelect={() =>
              runCommand(() => router.push(`${basePath}/research-library`))
            }
          >
          ...
          <CommandItem
            onSelect={() =>
              runCommand(() => router.push(`${basePath}/automations`))
            }
          >
        ...
        <CommandGroup heading="Settings">
          ...
          <CommandItem
            onSelect={() =>
              runCommand(() => router.push(`${basePath}/integrations`))
            }
          >
