...
export const BUSINESS_SECTORS: Sector[] = [
  ...
  },
  {
    ...
    name: "Hotels & Motels",
    shortName: "Hotels",
    description: "Hotels, motels, motor lodges - USBizData list",
    category: "business",
    icon: Hotel,
    color: "text-purple-500",
    bgColor: "bg-purple-50",
    filters: {},
    sicCodes: ["7011", "7021"], // Hotels, Motels
  },
  {
    id: "campgrounds_rv",
    name: "Campgrounds & RV Parks",
    shortName: "Campgrounds",
    description: "RV parks, campgrounds, camping facilities",
    category: "business",
    icon: TreePine,
    color: "text-green-600",
    bgColor: "bg-green-50",
    filters: {},
    sicCodes: ["7032", "7033"], // Sporting/recreational camps, RV parks
  },
  {
    id: "trucking",
    ...
    bgColor: "bg-blue-50",
    filters: {},
    sicCodes: ["4212", "4213", "4214", "4215"], // Local/long distance trucking
  },
  {
    id: "us_schools",
    name: "US Schools Database",
    shortName: "Schools",
    description: "K-12 schools, school districts - B2B/B2G opportunities",
    category: "business",
    icon: GraduationCap,
    color: "text-cyan-600",
    bgColor: "bg-cyan-50",
    filters: {},
    sicCodes: ["8211"], // Elementary/secondary schools
  },
  {
    ...
    bgColor: "bg-indigo-50",
    filters: {},
    sicCodes: ["8221", "8222", "8231", "8243", "8244", "8249", "8299"],
  },
  {
    id: "automotive",
    name: "Automotive",
