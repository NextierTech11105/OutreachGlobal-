...
export const SMS_TEMPLATES: SMSTemplate[] = [
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    stage: "opener",
    message:
      "Hi {firstName}, save 20+ hrs/week on outbound with AI. Quick call to show you? Reply STOP to opt out -NEXTIER",
    charCount: 113,
    variables: ["firstName"],
  },
  {
    ...
    stage: "nudge",
    message:
      "{firstName}, most founders are buried in sales tasks. I have a fix - 15 min call? Reply STOP to opt out -NEXTIER",
    charCount: 117,
    variables: ["firstName"],
  },
  {
    ...
    stage: "value",
    message:
      "{firstName}, scale outbound without hiring. Book 15 min: {link} Reply STOP to opt out -NEXTIER",
    charCount: 99,
  ...
  },
  {
    ...
    stage: "close",
    message:
      "Last note {firstName} - let me show you the system. No pitch: {link} Reply STOP to opt out -NEXTIER",
    charCount: 105,
    variables: ["firstName", "link"],
  },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    stage: "opener",
    message:
      "Hi {firstName}, lower your CAC with AI-powered outbound. Worth a look? Reply STOP to opt out -NEXTIER",
    charCount: 106,
    variables: ["firstName"],
  },
  {
    ...
    stage: "nudge",
    message:
      "{firstName}, automate your pipeline with qualified leads on autopilot. Quick demo? Reply STOP to opt out -NEXTIER",
    charCount: 118,
    variables: ["firstName"],
  },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    stage: "opener",
    message:
      "Hi {firstName}! Finding new listings takes time. Got a system that works. Want to see? Reply STOP to opt out -NEXTIER",
    charCount: 120,
    variables: ["firstName"],
  },
  {
    ...
    stage: "nudge",
    message:
      "{firstName}, automate your follow-up and never miss a lead. Quick call? Reply STOP to opt out -NEXTIER",
    charCount: 107,
    variables: ["firstName"],
  },
  {
    ...
    stage: "value",
    message:
      "{firstName}, top agents use this for more listings. 15 min to show you: {link} Reply STOP to opt out -NEXTIER",
    charCount: 116,
    variables: ["firstName", "link"],
  },
  {
    ...
    stage: "close",
    message:
      "Last message {firstName} - more listings, less cold calling: {link} Reply STOP to opt out -NEXTIER",
    charCount: 105,
    variables: ["firstName", "link"],
  },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    stage: "opener",
    message:
      "Hi {firstName}, off-market seller outreach at scale. Interested? Reply STOP to opt out -NEXTIER",
    charCount: 99,
    variables: ["firstName"],
  },
  {
    ...
    stage: "nudge",
    message:
      "{firstName}, replace cold calling with automated SMS that converts. 15 min? Reply STOP to opt out -NEXTIER",
    charCount: 112,
    variables: ["firstName"],
  },
  {
    ...
    stage: "value",
    message:
      "{firstName}, more off-market deals without the grind. See how: {link} Reply STOP to opt out -NEXTIER",
    charCount: 107,
    variables: ["firstName", "link"],
  },
  {
    ...
    stage: "close",
    message:
      "Last shot {firstName} - book 15 min and I'll show you the system: {link} Reply STOP to opt out -NEXTIER",
    charCount: 111,
    variables: ["firstName", "link"],
  },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    stage: "opener",
    message:
      "Hi {firstName}, get more {industry} leads on autopilot. Worth a look? Reply STOP to opt out -NEXTIER",
    charCount: 104,
  ...
  },
  {
    ...
    stage: "nudge",
    message:
      "{firstName}, automate your lead follow-up and close more jobs. Quick call? Reply STOP to opt out -NEXTIER",
    charCount: 110,
    variables: ["firstName"],
  },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    stage: "opener",
    message:
      "Hi {firstName}, streamline your fleet ops with AI automation. Worth a look? Reply STOP to opt out -NEXTIER",
    charCount: 111,
    variables: ["firstName"],
  },
  {
    ...
    stage: "nudge",
    message:
      "{firstName}, save time on dispatch and driver coordination. Quick call? Reply STOP to opt out -NEXTIER",
    charCount: 108,
    variables: ["firstName"],
  },
];
...
export const THE_BLITZ = {
  ...
  SCALE_PLAN: [
    ...
    { week: 4, target: 5000, description: "Full throttle on proven personas" },
    {
      week: 5,
      target: 5000,
      description: "Maintain, optimize response handling",
    },
