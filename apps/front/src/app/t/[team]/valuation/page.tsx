  ...
  const handleDownloadPDF = async () => {
    ...
    printWindow.document.write(`
      ...
      <body>
        ...
        <p><strong>Generated:</strong> ${sfd(new Date())}</p>

        <div class="value-box">
          <div class="amount">$${sf(val?.estimatedValue || 0)}</div>
        ...
        <div class="grid">
          ...
          <div class="stat">
            ...
            <div class="stat-value">${sf(prop?.squareFeet || prop?.buildingSize || 0)}</div>
          </div>
          <div class="stat">
        ...
        <div class="grid">
          ...
          <div class="stat">
            ...
            <div class="stat-value">$${sf(val?.comparableAvg || 0)}</div>
          </div>
          <div class="stat">
