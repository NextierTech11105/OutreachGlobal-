...
const NEXTIER_TEMPLATES = {
  ...
  nyDirect: {
    ...
    templates: [
      ...
      {
        name: "Growing or Dying",
        content:
          "{firstName}, you're either growing or dying. Which one is {companyName}?",
      },
      {
        name: "In or Out",
        content: "Hey {firstName}, I don't do maybes. You in or you out?",
      },
      {
        name: "Fortune Bold",
        content: "{firstName}, fortune favors the bold. Be bold. Call me.",
      },
    ],
  },
};
    ...
    <div className="space-y-6 p-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground">
          Click any template to copy it. Use in Pre-Queue or SMS.
        </p>
      </div>
      ...
      <Tabs defaultValue="atlantic" className="space-y-6">
        ...
        <TabsContent value="atlantic" className="space-y-8">
          <TemplateGroup
            group={ATLANTIC_COAST_TEMPLATES.dealership}
            prefix="dealer"
          />
          <TemplateGroup
            group={ATLANTIC_COAST_TEMPLATES.moving}
            prefix="moving"
          />
          <TemplateGroup
            group={ATLANTIC_COAST_TEMPLATES.carrier}
            prefix="carrier"
          />
          <TemplateGroup
            group={ATLANTIC_COAST_TEMPLATES.frank}
            prefix="frank"
          />
        </TabsContent>
