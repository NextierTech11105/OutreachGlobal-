    ...
    steps: [
      {
        ...
        message:
          "Love it! I can call you in the next 10 mins — or pick a time here: {{calendar_link}}. What works?",
        alternatives: [
      ...
      },
      {
        id: "confirm_time",
        message:
          "Locked in for {{scheduled_time}}. You'll get a calendar invite shortly. Looking forward to it!",
        alternatives: [
    ...
    steps: [
      {
        id: "offer_times",
        message:
          "Calling you now work? If not, I've got slots at {{time_1}} or {{time_2}} tomorrow. Which one?",
        alternatives: [
  ...
  send_info: {
    ...
    steps: [
      ...
      },
      {
        ...
        message:
          "Sent! It's a 3-min read. After you look it over, want me to schedule a quick call to walk through it together?",
        alternatives: [
    ...
    steps: [
      {
        id: "minimize",
        message:
          "Totally get it — running a business is no joke. Here's the thing: this call is literally 15 mins. Could save you months of headache. Worth it?",
        alternatives: [
      ...
      },
      {
        ...
        message:
          "What if I just sent you a quick email summary? You can read it when you have a sec. Best email?",
        alternatives: [
    ...
    steps: [
      {
        ...
        message:
          "Fair question — lots of spam out there. We're NEXTIER Technologies. You can Google us or check out nextier.com. I'm Gianna, and I work with Tommy Borruso who founded the company. Want me to send you our LinkedIn?",
        alternatives: [
      ...
      },
      {
        id: "offer_proof",
        message:
          "I can send you a case study from someone in {{industry}} if that helps. Or just Google 'NEXTIER Technologies reviews'. I'll wait.",
        alternatives: [
    ...
    steps: [
      {
        ...
        message:
          "Smart to have help. Quick q though — are they showing you what actual buyers would pay, or just comps? That's what we specialize in. Might be worth comparing.",
        alternatives: [
    ...
    steps: [
      {
        id: "reframe",
        message:
          "Wait — the valuation is free. Zero cost. We only make money if we find you a buyer and you decide to sell. No risk on your end.",
        alternatives: [
      ...
      },
      {
        id: "quantify_value",
        message:
          "Think of it this way: most owners I talk to are surprised by their number — usually 20-30% higher than they expected. Worth 15 mins to find out, right?",
        alternatives: [
    ...
    steps: [
      {
        ...
        message:
          "Totally get it — timing's everything. Mind if I ask: is it that you're not thinking about selling, or just not ready to explore it yet?",
        alternatives: [
      ...
      },
      {
        id: "schedule_future",
        message:
          "Got it. What if I checked back in 3 months? Sometimes timing just needs to catch up with opportunity.",
        alternatives: [
    ...
    steps: [
      {
        id: "exit",
        message:
          "Understood — appreciate you letting me know. If anything changes down the road, you've got my number. Best of luck with {{company_name}}!",
        alternatives: [
    ...
    steps: [
      {
        ...
        message:
          "I'm sorry — that wasn't my intention. I'll remove you from our list right now. Apologies for the inconvenience.",
        alternatives: [
    ...
    steps: [
      {
        id: "acknowledge",
        message:
          "Totally understand — timing matters. Mind if I check back in a few months? Things change.",
        alternatives: [
      ...
      },
      {
        id: "offer_value",
        message:
          "In the meantime — want me to send you our monthly market report for {{industry}}? No selling, just intel.",
        alternatives: [
    ...
    steps: [
      {
        ...
        message:
          "Good question — the short answer is {{brief_answer}}. But honestly, it's easier to explain in a quick call. Got 10 mins?",
        alternatives: [
    ...
    steps: [
      {
        id: "clarify",
        message:
          "Ha — my bad, let me start over. I'm Gianna with NEXTIER. We help business owners find out what their company is worth. Free, no obligation. Interested?",
        alternatives: [
    ...
    steps: [
      {
        id: "casual_bump",
        message:
          "Hey {{first_name}} — just bumping this up. Still curious about that valuation?",
        alternatives: [
    ...
    steps: [
      {
        ...
        message:
          "{{first_name}} — I'm starting to think you're playing hard to get 😂 Quick yes or no: worth a 15-min call?",
        alternatives: [
    ...
    steps: [
      {
        id: "breakup",
        message:
          "{{first_name}}, this is my last message. If you ever want to know what {{company_name}} is worth, you've got my number. Until then — best of luck! — Gianna",
        alternatives: [
 ...
 */
export function getFlowForResponse(
...
export function getIndustryOpener(
  industry: string,
  context: { first_name: string; company_name: string },
): string {
  const key = industry.toLowerCase().replace(/\s+/g, "_");
  const openers =
    INDUSTRY_OPENERS[key] || INDUSTRY_OPENERS["professional_services"];
