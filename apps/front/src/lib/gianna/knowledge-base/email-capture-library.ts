...
export const EMAIL_CAPTURE_CONFIRMATIONS: EmailCaptureTemplate[] = [
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    category: "standard",
    template:
      "{firstName} no problem ! I will have sent to you this weekend ! - {worker}",
  ...
  },
  {
    ...
    category: "standard",
    template:
      "Perfect {firstName}! Sending that over to {email} now. Check your inbox in a few! - {worker}",
  ...
  },
  {
    ...
    category: "standard",
    template:
      "{firstName} sure! I will have that sent over shortly. Talk soon! - {worker}",
    variables: ["firstName", "worker"],
    timing: "same_day",
  },
  {
    ...
    category: "standard",
    template:
      "Got it {firstName}! Your report is on its way to {email}. Let me know when you get it! - {worker}",
    variables: ["firstName", "email", "worker"],
    timing: "immediate",
  },
  {
    ...
    category: "standard",
    template:
      "You got it {firstName}! Sending to {email} now. Have a great day! - {worker}",
    variables: ["firstName", "email", "worker"],
    timing: "immediate",
  },
  {
    ...
    category: "standard",
    template:
      "{firstName} absolutely! I'll get that out to you by end of day. - {worker}",
    variables: ["firstName", "worker"],
    timing: "same_day",
  },
  {
    ...
    category: "standard",
    template:
      "Great {firstName}! Just queued that up for you. Should hit your inbox shortly! - {worker}",
    variables: ["firstName", "worker"],
    timing: "immediate",
  },
  {
    ...
    category: "standard",
    template:
      "{firstName} perfect! I'll have that in your inbox within the hour. - {worker}",
    variables: ["firstName", "worker"],
    timing: "immediate",
  },
  {
    ...
    category: "standard",
    template:
      "Done! Sending to {email} right now {firstName}. Check spam just in case! - {worker}",
  ...
  },
  {
    ...
    category: "standard",
    template:
      "{firstName} - on it! Look for an email from me shortly. Talk soon! - {worker}",
    variables: ["firstName", "worker"],
    timing: "same_day",
  },
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    category: "property",
    template:
      "{firstName} sure! I'll have that valuation report sent to you shortly. - {worker}",
    variables: ["firstName", "worker"],
    timing: "same_day",
  },
  {
    ...
    category: "property",
    template:
      "Perfect {firstName}! Property analysis for {propertyAddress} coming your way! - {worker}",
  ...
  },
  {
    ...
    category: "property",
    template:
      "{firstName} got it! I'll finalize the numbers on {propertyAddress} and send over today. - {worker}",
    variables: ["firstName", "propertyAddress", "worker"],
    timing: "same_day",
  },
  {
    ...
    category: "property",
    template:
      "You'll have that report in your inbox soon {firstName}. The numbers are interesting! - {worker}",
    variables: ["firstName", "worker"],
    timing: "same_day",
  },
  {
    ...
    category: "property",
    template:
      "{firstName} - sending your property breakdown to {email} now. Let me know if questions! - {worker}",
    variables: ["firstName", "email", "worker"],
    timing: "immediate",
  },
  {
    ...
    category: "property",
    template:
      "Got it {firstName}! I'll pull the latest comps for {propertyAddress} and send over. - {worker}",
    variables: ["firstName", "propertyAddress", "worker"],
    timing: "same_day",
  },
  {
    ...
    category: "property",
    template:
      "{firstName} perfect! Your valuation is almost ready - sending to {email} shortly! - {worker}",
    variables: ["firstName", "email", "worker"],
    timing: "same_day",
  },
  {
    ...
    category: "property",
    template:
      "Awesome {firstName}! The report on {propertyAddress} will be in your inbox soon. Exciting stuff! - {worker}",
    variables: ["firstName", "propertyAddress", "worker"],
    timing: "same_day",
  },
  {
    ...
    category: "property",
    template:
      "{firstName} sure thing! I'll have the full property analysis out to you by tomorrow. - {worker}",
    variables: ["firstName", "worker"],
    timing: "next_day",
  },
  {
    ...
    category: "property",
    template:
      "On it {firstName}! Your property report is being finalized now. Check your email soon! - {worker}",
    variables: ["firstName", "worker"],
    timing: "immediate",
  },
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    category: "business",
    template:
      "{firstName} great! I'll send over the business analysis shortly. Good stuff coming! - {worker}",
    variables: ["firstName", "worker"],
    timing: "same_day",
  },
  {
    ...
    category: "business",
    template:
      "Perfect {firstName}! Your exit strategy guide is on its way to {email}. - {worker}",
    variables: ["firstName", "email", "worker"],
    timing: "immediate",
  },
  {
    ...
    category: "business",
    template:
      "{firstName} you got it! Business valuation coming your way. The numbers might surprise you! - {worker}",
    variables: ["firstName", "worker"],
    timing: "same_day",
  },
  {
    ...
    category: "business",
    template:
      "Got it {firstName}! I'll send the AI efficiency report to {email} shortly. Game changer! - {worker}",
    variables: ["firstName", "email", "worker"],
    timing: "same_day",
  },
  {
    ...
    category: "business",
    template:
      "{firstName} - sending that over now. I think you'll find some quick wins in there! - {worker}",
    variables: ["firstName", "worker"],
    timing: "immediate",
  },
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    category: "warm",
    template:
      "Awesome {firstName}! So glad you're interested. Report heading to {email} now! - {worker}",
    variables: ["firstName", "email", "worker"],
    timing: "immediate",
  },
  {
    ...
    category: "warm",
    template:
      "{firstName} you're gonna love this! Sending it over now. Let's chat after you review! - {worker}",
    variables: ["firstName", "worker"],
    timing: "immediate",
  },
  {
    ...
    category: "warm",
    template:
      "Love it {firstName}! I'll get that to you ASAP. Excited to hear what you think! - {worker}",
    variables: ["firstName", "worker"],
    timing: "immediate",
  },
  {
    ...
    category: "warm",
    template:
      "{firstName} perfect timing! I was just finishing up your report. Sending now! - {worker}",
    variables: ["firstName", "worker"],
    timing: "immediate",
  },
  {
    ...
    category: "warm",
    template:
      "Excellent {firstName}! This is good stuff - can't wait for you to see it. On its way! - {worker}",
    variables: ["firstName", "worker"],
    timing: "immediate",
  },
  ...
  },
  {
    ...
    category: "weekend",
    template:
      "{firstName} sure! I'll have that ready for you by Monday. Enjoy your weekend! - {worker}",
    variables: ["firstName", "worker"],
    timing: "weekend",
  },
  {
    ...
    category: "weekend",
    template:
      "Got it {firstName}! Working on it this weekend. You'll have it Monday morning! - {worker}",
    variables: ["firstName", "worker"],
    timing: "weekend",
  },
  {
    ...
    category: "weekend",
    template:
      "{firstName} - sending over the weekend! Will follow up Monday to discuss. - {worker}",
    variables: ["firstName", "worker"],
    timing: "weekend",
  },
  {
    ...
    category: "weekend",
    template:
      "Perfect {firstName}! I'll get that finalized this weekend and send first thing Monday. - {worker}",
    variables: ["firstName", "worker"],
    timing: "weekend",
  },
];
...
export const CONTENT_LINK_CONFIRMATIONS: ContentLinkTemplate[] = [
  ...
  },
  {
    ...
    category: "article",
    template:
      "Great! Here's the piece I wrote: {contentUrl}\n\nWould love your feedback! - {worker}",
    variables: ["contentUrl", "worker"],
    contentType: "MEDIUM_ARTICLE",
  },
  {
  ...
  },
  {
    ...
    category: "blueprint",
    template:
      "{firstName} - sending that blueprint now: {contentUrl}\n\nLet me know what you think! - {worker}",
    variables: ["firstName", "contentUrl", "worker"],
    contentType: "ONE_PAGER",
  },
  {
  ...
  },
  {
    ...
    category: "warm",
    template:
      "{firstName} you're gonna dig this! {contentUrl}\n\nLet's chat after you read it! - {worker}",
    variables: ["firstName", "contentUrl", "worker"],
  },
  {
    id: "cl_warm_3",
    category: "warm",
    template:
      "Love the enthusiasm! Here you go: {contentUrl}\n\nCan't wait to hear your thoughts! - {worker}",
    variables: ["contentUrl", "worker"],
  },
...
export const CONTENT_LINK_FOLLOWUPS: FollowUpTemplate[] = [
  // 24 hours after link sent
  {
    ...
    timing: "24h",
    template:
      "Hey {firstName}! Did you get a chance to check out that article? What did you think? - {worker}",
    variables: ["firstName", "worker"],
  },
  {
    ...
    timing: "24h",
    template:
      "{firstName} - thoughts on that piece I sent? If you liked it, I've got more where that came from! - {worker}",
    variables: ["firstName", "worker"],
  },
  {
    ...
    timing: "24h",
    template:
      "{firstName}, hope you got a chance to read it! Curious which part stood out to you. - {worker}",
    variables: ["firstName", "worker"],
  },
  ...
  // 48 hours - pivot to email capture
  {
    ...
    timing: "48h",
    template:
      "Hey {firstName}! If you liked that article, I've got a full guide I can send. What's the best email? - {worker}",
    variables: ["firstName", "worker"],
  },
  {
    ...
    timing: "48h",
    template:
      "{firstName} - got some more in-depth stuff if you're interested. Best email to send it to? - {worker}",
    variables: ["firstName", "worker"],
  },
];
...
export const STRATEGY_SESSION_FOLLOWUPS: FollowUpTemplate[] = [
  // 24 hours after email sent
  {
    ...
    timing: "24h",
    template:
      "Hey {firstName}! Did you get a chance to look at that report I sent? Any questions? - {worker}",
    variables: ["firstName", "worker"],
  },
  {
    id: "followup_24h_2",
    timing: "24h",
    template:
      "{firstName} - checking in! Saw the email went through. What did you think of the numbers? - {worker}",
    variables: ["firstName", "worker"],
  },
  {
    id: "followup_24h_3",
    timing: "24h",
    template:
      "{firstName}, hope you got the report! Ready to chat whenever you are. - {worker}",
    variables: ["firstName", "worker"],
  },
  ...
  // 48 hours
  {
    ...
    timing: "48h",
    template:
      "{firstName} - just following up on that analysis I sent. Worth a 15-min chat? - {worker}",
    variables: ["firstName", "worker"],
  },
  {
    id: "followup_48h_2",
    timing: "48h",
    template:
      "Hey {firstName}! Any thoughts on the report? Happy to walk through it with you. - {worker}",
    variables: ["firstName", "worker"],
  },
  ...
  // 72 hours
  {
    ...
    timing: "72h",
    template:
      "{firstName}, still thinking about that property? I'm here when you're ready to chat. - {worker}",
    variables: ["firstName", "worker"],
  },
  {
    id: "followup_72h_2",
    timing: "72h",
    template:
      "Hey {firstName} - no pressure, just wanted to make sure you saw the report. Let me know! - {worker}",
    variables: ["firstName", "worker"],
  },
  ...
  // 1 week
  {
    ...
    timing: "1week",
    template:
      "{firstName}! Quick check-in. Still interested in discussing that analysis? - {worker}",
    variables: ["firstName", "worker"],
  },
  {
    id: "followup_1week_2",
    timing: "1week",
    template:
      "Hey {firstName}, just circling back. Happy to answer any questions when you're ready. - {worker}",
    variables: ["firstName", "worker"],
  },
];
...
export function getEmailCaptureConfirmation(
  ...
  const templates = EMAIL_CAPTURE_CONFIRMATIONS.filter(
  ...
  if (context?.propertyAddress)
    message = message.replace(/{propertyAddress}/g, context.propertyAddress);
...
export function getContentLinkConfirmation(
  ...
  const templates = CONTENT_LINK_CONFIRMATIONS.filter(
    (t) => t.category === category,
  );
  const template = templates[Math.floor(Math.random() * templates.length)];
  ...
  if (context?.contentUrl)
    message = message.replace(/{contentUrl}/g, context.contentUrl);
  if (context?.industry)
    message = message.replace(/{industry}/g, context.industry);
  if (context?.worker) message = message.replace(/{worker}/g, context.worker);
...
export function isContentPermission(message: string): boolean {
  ...
  return (
    !hasEmail &&
    upper.length < 50 &&
    PERMISSION_KEYWORDS.some((kw) => upper.includes(kw))
  );
}
...
export const DID_YOU_KNOW_FACTS: DidYouKnowTemplate[] = [
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    template:
      "Hey did you know Bushwick was originally a Dutch settlement called 'Boswijck' - little town in the woods? 🌳 - {worker}",
  },
  {
    ...
    template:
      "Quick fact - Bushwick had 14 breweries in the 1800s and was the beer capital of the US! 🍺 - {worker}",
  },
  {
    ...
    template:
      "Hey did you know the Williamsburg Bridge was the longest suspension bridge in the world when it opened in 1903? - {worker}",
  },
  {
    id: "dyk_ny_bedstuy_1",
    state: "NY",
    ...
    template:
      "Fun fact - Bed-Stuy has one of the largest collections of Victorian brownstones in the entire US! 🏠 - {worker}",
  },
  {
    id: "dyk_ny_redhook_1",
    state: "NY",
    ...
    template:
      "Hey did you know Red Hook got its name from the red clay soil and the hook-shaped peninsula? 🪝 - {worker}",
  },
  {
    id: "dyk_ny_dumbo_1",
    state: "NY",
    ...
    template:
      "Quick one - DUMBO stands for 'Down Under the Manhattan Bridge Overpass' - artists named it in the 70s! - {worker}",
  },
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    template:
      "Hey did you know Staten Island was almost sold to New Jersey in 1687 for just $12K? Close call! 😅 - {worker}",
  },
  {
    id: "dyk_ny_si_2",
    state: "NY",
    ...
    template:
      "Wild fact - Fresh Kills Landfill used to be the largest man-made structure visible from space! Now it's a park. - {worker}",
  },
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    template:
      "Hey did you know NJ has more diners than anywhere in the world? Over 500! 🍳 - {worker}",
  },
  {
    id: "dyk_nj_2",
    state: "NJ",
    ...
    template:
      "Quick fact - the first ever baseball game was played in Hoboken NJ in 1846! ⚾ - {worker}",
  },
  {
    id: "dyk_nj_newark_1",
    state: "NJ",
    ...
    template:
      "Hey did you know Newark is one of the oldest cities in America? Founded in 1666! - {worker}",
  },
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    template:
      "Hey did you know St. Augustine is the oldest city in the US? Founded 1565 - 55 years before Plymouth Rock! - {worker}",
  },
  {
    id: "dyk_fl_miami_1",
    state: "FL",
    ...
    template:
      "Quick fact - Miami is the only major US city founded by a woman! Julia Tuttle in 1896. 👏 - {worker}",
  },
  {
    id: "dyk_fl_2",
    state: "FL",
    ...
    template:
      "Hey did you know Florida has more golf courses than any other state? Over 1,250! ⛳ - {worker}",
  },
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    template:
      "Hey did you know Texas was its own country for 9 years? Republic of Texas 1836-1845! 🤠 - {worker}",
  },
  {
    id: "dyk_tx_houston_1",
    state: "TX",
    ...
    template:
      "Quick fact - Houston has no zoning laws! One of the only major cities in the US without them. - {worker}",
  },
  {
    id: "dyk_tx_austin_1",
    state: "TX",
    ...
    template:
      "Hey did you know Austin has 1.5 million bats living under Congress Ave Bridge? Largest urban colony in NA! 🦇 - {worker}",
  },
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    template:
      "Hey did you know California's economy is the 5th largest in the entire world? Bigger than the UK! - {worker}",
  },
  {
    id: "dyk_ca_la_1",
    state: "CA",
    ...
    template:
      "Fun fact - LA's full original name is 44 letters long! 'El Pueblo de Nuestra Señora la Reina de los Ángeles...' - {worker}",
  },
  {
    id: "dyk_ca_sf_1",
    state: "CA",
    ...
    template:
      "Hey did you know the Golden Gate Bridge was almost painted black and yellow? Navy wanted it for visibility! 🐝 - {worker}",
  },
];
...
export function getDidYouKnowFact(context: {
  ...
  if (context.neighborhood) {
    const neighborhoodFacts = facts.filter(
      (f) =>
    ...
    const cityFacts = facts.filter(
      (f) => f.city?.toLowerCase() === context.city?.toLowerCase(),
    );
    if (cityFacts.length > 0) facts = cityFacts;
  } else if (context.state) {
    const stateFacts = facts.filter(
      (f) => f.state.toLowerCase() === context.state?.toLowerCase(),
    );
