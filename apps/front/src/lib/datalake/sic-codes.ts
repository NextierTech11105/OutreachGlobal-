...
export const SIC_CODES: Record<string, SICCode> = {
  ...
  "1542": {
    code: "1542",
    description: "General Contractors Nonresidential Buildings",
    count: 168166,
    sector: "construction-contractors",
    subsector: "commercial-builders",
  },
  ...
  "1752": {
    code: "1752",
    description: "Floor Laying and Other Floor Work",
    count: 19906,
    sector: "construction-contractors",
    subsector: "flooring",
  },
  ...
  "1795": {
    ...
    count: 7069,
    sector: "construction-contractors",
    subsector: "demolition",
  },
  "1796": {
    code: "1796",
    description: "Installation or Erection of Building Equipment",
    count: 13754,
    sector: "construction-contractors",
    subsector: "installation",
  },
  "1799": {
    code: "1799",
  ...
  "4212": {
    ...
    sector: "transportation-logistics",
    subsector: "trucking",
    bucketId: "us-transport-trucking",
  },
  "4213": {
    code: "4213",
  ...
  "4225": {
    ...
    sector: "transportation-logistics",
    subsector: "warehousing",
    bucketId: "us-transport-warehousing",
  },
  "4226": {
    code: "4226",
  ...
  "7033": {
    ...
    bucketId: "us-hospitality-campgrounds-rv",
  },
  "7041": {
    code: "7041",
    description: "Organization Hotels and Lodging Houses",
    count: 3925,
    sector: "hotels-hospitality",
  ...
  "7212": {
    code: "7212",
    description: "Garment Pressing, and Agents for Laundries",
    count: 14987,
    sector: "personal-services",
    subsector: "pressing",
  },
  ...
  "7215": {
    ...
    bucketId: "us-personal-laundromats",
  },
  "7216": {
    code: "7216",
  ...
  "7261": {
    ...
    bucketId: "us-personal-funeral-homes",
  },
  "7291": {
    code: "7291",
  ...
  "7374": {
    code: "7374",
    description: "Computer Processing and Data Preparation",
    count: 297004,
    sector: "business-services",
    subsector: "it-services",
  },
  ...
  "8111": {
    ...
    bucketId: "us-prof-legal-services",
  },
  "8711": {
    code: "8711",
  ...
  "6531": {
    ...
    bucketId: "us-realestate-agents-brokers",
  },
  "6541": {
    code: "6541",
  ...
  "6411": {
    ...
    bucketId: "us-finance-insurance-agents",
  },
  ...
  "5421": {
    code: "5421",
    description: "Meat and Fish (Seafood) Markets",
    count: 9217,
    sector: "retail-stores",
    subsector: "meat-fish",
  },
  ...
  "7929": {
    code: "7929",
    description: "Bands, Orchestras, Actors, and Other Entertainers",
    count: 63199,
    sector: "recreation-entertainment",
  ...
  "3241": {
    ...
    bucketId: "us-mfg-cement-concrete",
  },
  "3272": {
    code: "3272",
...
export function searchSICs(query: string): SICCode[] {
  ...
  return Object.values(SIC_CODES).filter(
    (s) => s.description.toLowerCase().includes(q) || s.code.includes(q),
  );
}
...
export const SIC_SUMMARY = {
  ...
  topSectors: [
    {
      sector: "healthcare-medical",
      count: getSectorCount("healthcare-medical"),
    },
    {
      sector: "professional-services",
      count: getSectorCount("professional-services"),
    },
    { sector: "real-estate", count: getSectorCount("real-estate") },
    {
      sector: "financial-services",
      count: getSectorCount("financial-services"),
    },
...
console.log(
  `[SIC Codes] Loaded ${Object.keys(SIC_CODES).length} SIC code definitions`,
);
