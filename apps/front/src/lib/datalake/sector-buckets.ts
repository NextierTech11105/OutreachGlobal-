...
export const NATIONAL_BUCKETS: SectorBucket[] = [
  ...
  {
    id: "us-prof-consulting",
    name: "US Management Consulting",
    sector: "professional-services",
    subsector: "consulting",
    sicCodes: ["8742"],
    storagePath:
  ...
  {
    id: "us-prof-marketing-agencies",
    name: "US Marketing Agencies",
    sector: "professional-services",
  ...
  {
    id: "us-biz-advertising",
    name: "US Advertising Agencies",
    sector: "business-services",
    subsector: "advertising",
    sicCodes: ["7311"],
    storagePath: "datalake/business/us/sectors/business-services/advertising/",
    description: "US Advertising agencies - WHITE LABEL PROSPECTS",
    state: "US",
    tags: ["advertising", "agencies", "white-label-prospects"],
  },
  {
    id: "us-biz-staffing",
    name: "US Staffing Agencies",
    sector: "business-services",
    subsector: "staffing",
    sicCodes: ["7361"],
    storagePath: "datalake/business/us/sectors/business-services/staffing/",
    description: "US Staffing & employment agencies - WHITE LABEL PROSPECTS",
    state: "US",
    tags: ["staffing", "agencies", "white-label-prospects"],
  },
  {
    id: "us-prof-accounting",
    name: "US Accounting & CPA Firms",
    sector: "professional-services",
    subsector: "accounting",
    sicCodes: ["8721"],
    storagePath:
